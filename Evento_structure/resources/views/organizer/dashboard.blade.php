...
<body>
  <div class="flex h-screen bg-gray-800 " :class="{ 'overflow-hidden': isSideMenuOpen }">
    ...
    <div class="flex flex-col flex-1 w-full overflow-y-auto">
      ...
      <main class="">
        <div class="flex flex-wrap gap-10 h-auto mb-4 pb-10 px-8 mx-4 rounded-3xl bg-gray-100 border-4 border-red-600">
          <a href="{{ route('event.create') }}" data-modal-target="authentication-modal" data-modal-toggle="authentication-modal" class="" type="button">
